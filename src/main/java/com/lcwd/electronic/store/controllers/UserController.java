...
public class UserController {
    ...
    public ResponseEntity<List<UserDto>> searchByKeyword(@PathVariable("keywords") String keyword){
    ...
    public ResponseEntity<ImageResponse> uploadImageUser(@PathVariable String userId,
...
//        return new ResponseEntity<>(imageResponse, HttpStatus.CREATED);
        ...
        // Call the correct upload method
        String imageName = fileService.uploadImage(image, imageUploadPath);

        // Get the user and update their image name
        UserDto user = userService.getUserById(userId);
        user.setImageName(imageName);
        UserDto userDto = userService.updateUser(user, userId);

        // Build the response with a success message
        ImageResponse imageResponse = ImageResponse.builder()
                .imageName(imageName)
                .success(true)
